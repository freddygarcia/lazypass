...
{:else}
    <main class="container">
        <div class="card auth-card">
            ...
            <h2>LazyPass Locked</h2>
            <p class="subtitle">Authenticate to access</p>

            <button class="generate-btn" onclick={checkAuth}>
                Authenticate
            </button>
            {#if authError}
